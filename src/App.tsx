...
import HREventsPage from './pages/hr/EventsPage'; 
import CameraVerification from "./pages/hr/CameraVerification";
import FormsAndRequests from './pages/hr/FormsAndRequests';
